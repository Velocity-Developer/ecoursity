...
use Ecoursity\App\Shortcodes\CartIconShortcode;
use Ecoursity\App\Shortcodes\CheckoutShortcode;
...
use Ecoursity\App\Shortcodes\InstructorCoursesShortcode;
...
class Shortcode
{
    public function boot(): void
    {
        ...
        add_shortcode('ecoursity-cart-icon', [CartIconShortcode::class, 'render']);
        add_shortcode('ecoursity-checkout', [CheckoutShortcode::class, 'render']);
